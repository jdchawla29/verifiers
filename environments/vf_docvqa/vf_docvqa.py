...
[Your concise answer here]
    ...
    def data_collator(batch):
        ...
        for sample in batch:
            ...
            sample["answer"] = "|".join(sample["answers"]) if isinstance(sample["answers"], list) else sample["answers"]
    ...
    def answer_match_reward(completion, answer, **kwargs):
        ...
        for acceptable in acceptable_answers:
            if acceptable.strip().lower() in response or response in acceptable.strip().lower():
                return 1.0
        return 0.0
